...
function agregarItemAlCarrito(titulo, precio, imagenSrc){
    ...
    <div class="carrito-item">
                    ...
                    <div class="carito-item-detalles">
...
function pagarClicked (event){
    ...
    console.log("Carrito de compras:", carritoItems);
    console.log("Número de elementos en el carrito:", carritoItems ? carritoItems.childElementCount : "No se encontró el carrito");

    // Verificar si hay elementos en el carrito
    if (carritoItems && carritoItems.firstChild) {
        ...
        // Ocultar el carrito (puedes agregar tu lógica aquí)
        ocultarCarrito();
    } else {
        alert("No se ha seleccionado ningún item. Agregue productos al carrito antes de pagar.");
    }
}
